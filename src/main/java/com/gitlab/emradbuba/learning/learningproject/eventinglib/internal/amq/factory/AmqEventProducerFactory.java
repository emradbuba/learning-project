...
import com.gitlab.emradbuba.learning.learningproject.eventinglib.internal.amq.producer.strategy.ActiveMQEventProducerVirtualTopic;
...
public class AmqEventProducerFactory {
    ...
    public EventProducer createEventProducer(final EventProducerSettingsCore eventProducerSettingsCore) {
        ...
        return switch (eventCommunicationModelType) {
            ...
            case AMQ_VIRTUAL_TOPIC -> new ActiveMQEventProducerVirtualTopic(eventProducerSettingsCore);
        };
    }
}
