...
public class PersonCommandValidator {
    ...
    private static void validateFirstName(final String firstName) {
        if (StringUtils.isBlank(firstName)) {
            throw new LearningProjectIncorrectInputException("Incorrect person input data")
                    .withHttpStatusCodeValue(422)
                    .withUniqueErrorCode(ExceptionErrorCode.INCORRECT_PERSON_FIRST_NAME_IS_EMPTY.getReasonCode())
                    .withDescription(ExceptionErrorCode.INCORRECT_PERSON_FIRST_NAME_IS_EMPTY.getDescription())
    ...
    private static void validateSurname(String surname) {
        if (StringUtils.isBlank(surname)) {
            throw new LearningProjectIncorrectInputException("Incorrect person input data")
                    .withHttpStatusCodeValue(422)
                    .withUniqueErrorCode(ExceptionErrorCode.INCORRECT_PERSON_SURNAME_IS_EMPTY.getReasonCode())
                    .withDescription(ExceptionErrorCode.INCORRECT_PERSON_SURNAME_IS_EMPTY.getDescription())
    ...
    private static void validateDateOfBirth(final LocalDate dateOfBirth) {
        if (dateOfBirth == null) {
            throw new LearningProjectIncorrectInputException("Incorrect person input data")
                    .withHttpStatusCodeValue(422)
                    .withUniqueErrorCode(ExceptionErrorCode.INCORRECT_PERSON_BIRTH_DATE_IS_EMPTY.getReasonCode())
                    .withDescription(ExceptionErrorCode.INCORRECT_PERSON_BIRTH_DATE_IS_EMPTY.getDescription())
        ...
        if (isUnder18) {
            throw new LearningProjectIncorrectInputException("Incorrect person input data")
                    .withHttpStatusCodeValue(422)
                    .withUniqueErrorCode(ExceptionErrorCode.INCORRECT_PERSON_BIRTH_DATE_IS_TOO_YOUNG.getReasonCode())
                    .withDescription(ExceptionErrorCode.INCORRECT_PERSON_BIRTH_DATE_IS_TOO_YOUNG.getDescription())
